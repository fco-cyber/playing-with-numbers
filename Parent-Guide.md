# Mayah's Rainbow Reef — Guide for Marcus
...
- *Rainbow*: tap a number to see its partner that makes the target.
- *Build it*: a ten-frame + part-part-whole model where one part auto-completes the other — exactly "start from the whole, find the two parts."
- *All ways*: the complete, exhaustive list of every addition **and** subtraction for 5, 10, 20 or 100.
...
- Let her **choose** the adventure — autonomy boosts engagement.
- Start each session with one **easy win** (e.g. Rainbow *Build it*) before something harder.
- Praise **effort and strategy** ("you counted the hops carefully"), not just correct answers. The app never says "wrong" — only gentle "try again" prompts.
- Sit alongside her for the first few goes and **say the numbers together**.

## Aligned to the Victorian Curriculum (Mathematics, Level 2)
Counting to/from 1000, place value (ones, tens, hundreds), locating numbers, counting forwards/backwards, and partitioning numbers into parts — all covered here.

*If a particular area stays tricky after a few weeks, her classroom teacher can point you to the school's intervention resources, and these activities pair well with hands-on counters at home.*
